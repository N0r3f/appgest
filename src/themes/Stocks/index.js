  ...
  return (
    <div className="stocks-container">
      ...
      <div className="stocks">
        <Link href="/themes/Stocks/securite" legacyBehavior><a className="tile tile6">Sécu</a></Link>
        <Link href="/themes/Stocks/alerte" legacyBehavior><a className="tile tile7">Alerte</a></Link>
        <Link href="/themes/Stocks/saisonnier" legacyBehavior><a className="tile tile8">Saison</a></Link>
        <Link href="/themes/Stocks/transit" legacyBehavior><a className="tile tile9">Transit</a></Link>
        <Link href="/themes/Stocks/speculatif" legacyBehavior><a className="tile tile10">Spécu</a></Link>
        <Link href="/themes/Stocks/cyclique" legacyBehavior><a className="tile tile11">Cycle</a></Link>
